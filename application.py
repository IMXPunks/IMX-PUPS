...
def return_on_each_call(variable):
	github_url = f'https://raw.githubusercontent.com/IMXPunks/AWS-API-PUPS/main/metadata/{variable}.json'
# 	github_url = f'https://raw.githubusercontent.com/sahilsngh/samples/main/metadata/{variable}.json'
	response = requests.get(github_url)
	metadata = json.loads(response.text)
	return metadata

@application.route('/schema', methods=['GET'])
def return_on_each_call(variable):
	github_url = f'https://raw.githubusercontent.com/IMXPunks/AWS-API-PUPS/main/json/schema.json'
# 	github_url = f'https://raw.githubusercontent.com/sahilsngh/samples/main/metadata/{variable}.json'
	response = requests.get(github_url)
	metadata = json.loads(response.text)
	return metadata
